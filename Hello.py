...
def simpanData(c1,c2,c3,c4):
        if 'nilai_kriteria' not in st.session_state:
            ...
            dataBaru = np.append(dataLama, [[c1,c2,c3,c4]], axis=0)
...
def run():
    ...
    st.write("## INPUT NILAI KRITERIA UNTUK TIAP ALTERNATIF (LAKUKAN HINGGA BEBERAPA KALI)")
    ...
    c3 = st.slider("Nilai C3", min_value=10, max_value=999, value=20, step=1)
